 ...
 */
public class ConfirmContextCall
    extends AbstractContextCall
{

    /**
     * Instantiates a new verify connection call.
     *
     * @param _environment the _environment
     */
    public ConfirmContextCall(final Environment _environment)
    {
        super(_environment, "confirm");
    }
